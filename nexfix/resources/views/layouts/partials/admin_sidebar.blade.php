        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                        class="fa fa-laptop me-2"></i>Vendors</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="{{ route('vendors.create') }}" class="dropdown-item fw-bold">Add Vendor</a>
                    <a href="{{ route('vendors.index') }}" class="dropdown-item fw-bold">View Vendor</a>
                </div>
            </div>
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                        class="fa fa-th me-2"></i>Service category</a>
                <div class="dropdown-menu bg-transparent border-0">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                        class="fa fa-keyboard me-2"></i>Bookings</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="{{ route('bookings.create') }}" class="dropdown-item fw-bold">Add Booking</a>
            ...
            <div class="nav-item dropdown">
                <a href="{{route('admin.reports.index')}}" class="nav-link "><i
                        class="fa fa-table me-2"></i>reports</a>
