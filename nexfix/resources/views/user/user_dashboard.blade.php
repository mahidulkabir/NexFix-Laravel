            ...
            <div class="col-lg-5">
                <div class="card p-4">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li>💸 Payment for booking <strong>#1023</strong> confirmed.</li>
                        <li>✅ Vendor <strong>CleanPro</strong> marked your service as completed.</li>
                        <li>💬 You received a message from <strong>PlumberMan</strong>.</li>
                    </ul>
                </div>
            </div>
        </div>
